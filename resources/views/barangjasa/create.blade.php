...
@section('title', 'Tambah Barang/Jasa - SIM BOQ Enterprise')
...
@section('content')
    ...
    <div class="mb-4 d-flex align-items-center">
        ...
        <div>
            <h2 class="fw-bold text-main mb-1">Tambah Barang / Jasa Baru</h2>
            <p class="text-muted-custom mb-0">Tambahkan master data material atau jasa untuk proyek.</p>
        </div>
    </div>
    ...
    <div class="form-container mb-5">
        ...
        <form action="{{ route('barangjasa.store') }}" method="POST">
            @csrf
            <div class="row g-4 mb-4">
                <div class="col-md-4">
                    <label for="kode_barang" class="form-label">Kode Item <span class="text-danger">*</span></label>
                    <input type="text" class="form-control font-monospace text-uppercase" id="kode_barang" name="kode_barang" placeholder="Cth: M-001" value="{{ old('kode_barang') }}" required autofocus>
                </div>
                
                <div class="col-md-8">
                    <label for="nama_barang" class="form-label">Nama Barang / Jasa <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="nama_barang" name="nama_barang" placeholder="Cth: Kabel Fiber Optik 24 Core" value="{{ old('nama_barang') }}" required>
                </div>

                <div class="col-md-6">
                    <label for="satuan" class="form-label">Satuan <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="satuan" name="satuan" placeholder="Cth: Meter, Unit, Lot, Roll" value="{{ old('satuan') }}" required>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="position-relative">
                        <select class="form-select" id="tipe" name="tipe" required style="appearance: none;">
                            ...
                            <option value="Material" {{ old('tipe') == 'Material' ? 'selected' : '' }}>Barang / Material Fisik</option>
                            <option value="Jasa" {{ old('tipe') == 'Jasa' ? 'selected' : '' }}>Servis / Jasa Pengerjaan</option>
                        </select>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control" id="harga_material" name="harga_material" placeholder="0" value="{{ old('harga_material') }}" min="0" step="1">
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <span class="input-group-text bg-body border-custom text-muted-custom">Rp</span>
                        <input type="number" class="form-control" id="harga_jasa" name="harga_jasa" placeholder="0" value="{{ old('harga_jasa') }}" min="0" step="1">
                    </div>
            ...
            <div class="d-flex justify-content-end gap-3">
                ...
                <button type="submit" class="btn btn-primary">
                    Simpan Item <i class="bi bi-arrow-right ms-2"></i>
                </button>
            </div>
        </form>
    </div>
